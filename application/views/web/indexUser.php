<header>
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-md-2"><img src="<?php echo base_url('public/img/logo2.png'); ?>" class="img-responsive"></div>
            ...
            <div class="col-sm-4 ">
                <div class="col-sm-1 col-md-3"><img src="<?php echo base_url('public/img/phone.png'); ?>" class="img-responsive"></div>
                 <div class="col-md-5">
...
<a href="#" class="see-all">See All MP3 Players</a> </div>
</li>
</ul>
</div>
            ...
            <!-- Wrapper for slides -->
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="<?php echo base_url('public/img/propaganda1.jpg'); ?>" alt="Los Angeles">
                     </div>

                    <div class="item">
                        <img src="<?php echo base_url('public/img/propaganda2.jpg'); ?>" alt="Chicago">
                    </div>

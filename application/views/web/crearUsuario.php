    <div class="row mt-50 mb-50">
      <div class="col-xs-10 col-xs-offset-1">
        <h1>Crear Usuario</h1>
        <hr>
        <form action="<?php echo base_url('usuario/crearUsuario') ?>" method="POST">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="password" class="form-control" name="clave" required placeholder="Ingrese una Contraseña">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="cedula" required placeholder="Ingrese su Nro. de Cedula" pattern="[0-9]{10}" value="<?php echo !empty($user['cedula'])?$user['cedula']:''; ?>">
